      ...
      .subscribe(
        onNext = {
          case (temp1, temp2) =>
            ...
            // alerta si la diferencia absoluta entre las lecturas de Sensor1 y Sensor2 es mayor a 5°C
            if (diff > 5)
  ...
  object sistemaAlertaComplejo extends App{
    ...
    sensor1.zip(sensor2).zip(sensor3)
      ...
      .subscribe(
        ...
        onNext = {
          case ((temp, hume), pre) => println(s"Temperature: $temp°C | Humidity: $hume% | Pressure: $pre hPa")
            ...
            if (hume < 40 || hume > 60)
              ...
              println(s"🚨 ALERT! Humidity out of range: $hume%")
