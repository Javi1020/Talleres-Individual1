...
object sumaReactivaNumeros extends App{
  ...
  val calificaciones = Var(List(6, 7, 8, 9, 10))

  // Elementos a sumar
  val acumulado = Signal{calificaciones.value.sum}

  // Observador
  val observer = acumulado.observe {nuevoAcumulado => println(s"Total de la suma = $nuevoAcumulado")}
...
**Figura 1
<img width="1920" height="1020" alt="image" src="https://github.com/user-attachments/assets/0ec71c88-b257-41c3-8665-94616ff21212" />
...
object calculoEnergiaCineticaVehiculo extends App{
  // Valores correspondientes a la masa y la velocidad
  // Variables reactivas
  var masa = Var(1000)
  var velocidad = Var(30)

  // Implementacion de la funcion de energia cincetica
  var Energiac = Signal{0.5*(masa.value*(velocidad.value * velocidad.value))}

  // Observador
  var observer = Energiac.observe{v =>
    if(v > 1000000){
      println(s"Alerta: Energía cinética muy alta, reduzca la velocidad.: $v")
    }else {
      println(s"La energia cinética: $v")
    }
  }
...
**Figura 2
<img width="1920" height="1020" alt="image" src="https://github.com/user-attachments/assets/4ab91104-d700-4c96-acd0-bc9631805f95" />
